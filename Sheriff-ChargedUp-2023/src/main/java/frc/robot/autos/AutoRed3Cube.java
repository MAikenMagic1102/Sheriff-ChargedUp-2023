...
public class AutoRed3Cube extends SequentialCommandGroup {
    public AutoRed3Cube(Swerve s_Swerve, Arm a_Arm, Intake i_Intake, DigitalServo servo){
            ...
            addCommands(
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        ...
                        s_Swerve.followTrajectoryCommand(test3, false).alongWith(new InstantCommand(() -> i_Intake.intakeIn()).alongWith(new ArmToSetpoint(a_Arm, Constants.Arm.FLOORLOAD))),
                        s_Swerve.followTrajectoryCommand(test4, false).alongWith(new InstantCommand(() -> i_Intake.setholdPosition()).alongWith(new ArmToSetpoint(a_Arm, Constants.Arm.SUBSTATION))),
                        new ArmToNode(a_Arm, 2),
                        new Score(a_Arm, i_Intake),
